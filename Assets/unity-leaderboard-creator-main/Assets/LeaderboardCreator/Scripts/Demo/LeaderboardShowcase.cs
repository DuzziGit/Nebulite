...
namespace Dan.Demo
{
    public class LeaderboardShowcase : MonoBehaviour
    {
        ...
        public void Load()
        {
            ...
            Leaderboards.geggsend_go.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
        ...
        public void Submit()
        {
            Leaderboards.geggsend_go.UploadNewEntry(_playerUsernameInput.text, _playerScore, Callback, ErrorCallback);
        }
        
        public void DeleteEntry()
        {
            Leaderboards.geggsend_go.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.geggsend_go.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
